...
exports.DatosVeterinaria = void 0;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
class DatosVeterinaria {
    constructor() {
        this.cargarDatosVeterinaria = (veterinariaNombre, basePath) => {
        ...
        this.guardarDatosVeterinaria = (veterinariaNombre, datos, basePath) => {
            const filePath = path_1.default.join(basePath, `${veterinariaNombre.replace(/\s+/g, "-").toLowerCase()}.json`);
            fs_1.default.writeFileSync(filePath, JSON.stringify(datos, null, 2), "utf8");
        };
    }
}
exports.DatosVeterinaria = DatosVeterinaria;
